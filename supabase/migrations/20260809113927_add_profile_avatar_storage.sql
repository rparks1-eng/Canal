...
drop policy if exists "Profile owners can create avatars" on storage.objects;
create policy "Profile owners can create avatars"
...
drop policy if exists "Profile owners can read avatars" on storage.objects;
create policy "Profile owners can read avatars"
