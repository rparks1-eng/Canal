...
const styles = StyleSheet.create({
  ...
  center: { flex: 1, alignItems: "center", justifyContent: "center", backgroundColor: "#080B0C" },
  ...
  eyebrow: { color: "#72D8C4", fontSize: 10, fontWeight: "900", letterSpacing: 1.5 },
  ...
  inviteText: { color: "#F7F4EC", fontSize: 13, fontWeight: "800" },
  titleBlock: { gap: 4 },
  title: { color: "#F7F4EC", fontFamily: "Georgia", fontSize: 29, fontWeight: "900" },
  subtitle: { color: "#9DA6A1", fontSize: 13 },
  sectionLabel: { color: "#72D8C4", fontSize: 10, fontWeight: "900", letterSpacing: 1.2 },
  ...
  grow: { flex: 1 },
  personName: { color: "#F7F4EC", fontSize: 14, fontWeight: "800" },
  personMeta: { color: "#9DA6A1", fontSize: 12, marginTop: 3 },
  ready: { color: "#72D8C4", fontSize: 10, fontWeight: "900" },
  ...
  secondaryText: { color: "#F7F4EC", fontSize: 14, fontWeight: "800" },
  enter: { minHeight: 50, alignItems: "center", justifyContent: "center" },
  enterText: { color: "#72D8C4", fontSize: 14, fontWeight: "900" },
