...
const styles = StyleSheet.create({
  ...
  headerIcon:{alignItems:"center",justifyContent:"center",minHeight:48,minWidth:48}, headerIconText:{color:"#F7F4EC",fontSize:35,lineHeight:38}, closeIconText:{color:"#F7F4EC",fontSize:25},
  hero:{gap:6,paddingVertical:10}, eyebrow:{color:"#72D8C4",fontSize:11,fontWeight:"900",letterSpacing:1.4}, title:{color:"#FFFFFF",fontFamily:"Georgia",fontSize:38,fontWeight:"700"}, subtitle:{color:"rgba(255,255,255,.78)",fontSize:15,lineHeight:22},
  ...
  textInput:{backgroundColor:"rgba(8,29,50,.26)",borderColor:"rgba(255,255,255,.17)",borderRadius:17,borderWidth:1,color:"#FFFFFF",fontSize:15,minHeight:50,paddingHorizontal:14,paddingVertical:12},sceneNameInput:{fontFamily:"Georgia",fontSize:18},notesInput:{minHeight:100,textAlignVertical:"top"},genreSearchInput:{marginTop:2},genreSuggestions:{gap:8},genreSuggestionLabel:{color:"rgba(255,255,255,.55)",fontSize:11,fontWeight:"800"},genreEmptyText:{color:"rgba(255,255,255,.65)",fontSize:13},selectedGenreSection:{gap:8},selectedGenreLabel:{color:"#72D8C4",fontSize:11,fontWeight:"800"},
  ...
  suggestNameButton:{alignItems:"center",justifyContent:"center",minHeight:48,paddingHorizontal:8},suggestNameText:{color:"#72D8C4",fontSize:13,fontWeight:"900"},statusText:{color:"#FFFFFF",fontSize:13,lineHeight:19},validationText:{color:"#FFD1C7",fontSize:13,fontWeight:"800"},disabled:{opacity:.45},pressed:{opacity:.72},
});
